...
<ol class="breadcrumb">
    <li class="active">
        <i class="fa fa-dashboard"></i> <a href="<?php echo $url?>index.php">Dashboard</a> / Tin tức
    </li>
</ol>
...
<div class="well">
    <div class="row">
        ...
        <div class="col-lg-12">
        	<div id="add" style="margin-bottom:5px;"><a href="<?php echo $url; ?>index.php?page=news&action=add&form=1" class="btn btn-success">Thêm mới</a></div>
                ...
                <table align="center" class="table table-bordered table-hover table-striped">
                    <thead>
                        <tr>
                            ...
                            <td width="61" align="center" style="font-weight: bold">Tiêu đề</td>
                    ...
                    <tbody>
                        ...
                        <tr <?php if(($key%2==0)) echo "class='success'"; else echo "class='danger'";  ?>>
                            ...
                            <td align="center"><img src="<?php echo $item['image_link'] ?>" width="120px;" height="100px;"/></td>
                            <td align="center"><?php echo $item['title'] ?></td>
                            <td align="center"><?php echo mb_substr($item['header'],0,200,'UTF-8'); ?></td>
                            <td align="center"><?php echo $item['created'] ?></td>
                            <td align="center" class="action-f" style="text-align:center;">
                                <a href="<?php echo $url; ?>index.php?page=news&action=del&id=<?php echo $item['id'] ?>"
                                    onClick="return confirm('Do you want to delete this record ?')">
                                    <i class="glyphicon glyphicon-remove"></i>
                                </a>
                                
                                <a href="<?php echo $url; ?>index.php?page=news&action=edit&form=1&id=<?php echo $item['id'] ?>">
