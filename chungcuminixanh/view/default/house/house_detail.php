  ...
  function initialize() {
    ...
    text= "<p style='color:#007639;text-align:center;' " + 
             "><b><?php echo $data_house->name_product;?><br />ĐC : <?php echo $data_house->addr;?> <br />Hotline : <?php echo $str_configs->hotline;?></b></p>" 
         ;
 ...
 <?php include('view/default/boxsearch.php');?>
        <div class="header_news">
            <p class="title"><a href="<?php echo $url?>home">Trang chủ</a></p><p class="title"><a href="<?php echo $url?>product/<?php echo $data_house->id_product;?>"/>Sản phẩm</a></p><p>Thông tin chi tiết</p>
        </div>
        <section class="itq-content">
			<section class="ndt-info-golf">
            	<div class="img-detail-info">
               	  <img src="<?php echo $data_house->image_house;?>"/>
                </div>
            	<div class="house-detail-info">
                    <table class="house">
                        <tr>
                            <th width="51" align="center">Thông tin </th>
                            <th width="165" align="center">Chi tiết</th>
                            
                        </tr>
                        <tr>
                            <td align="left">Dự án</td>
                            <td align="left"><?php echo $data_house->name_product;?></td>
						...
						?>  
                        <?php
						  if($data_house->office_none==1)
						  {
						  ?>
                        <tr>
                            <td align="left">Giá</td>
                            <td align="left"><?php echo $lib->formatmoney($data_house->cost_house);?> VNĐ</td>
           	  ...
           	  <table width="1089" class="room">
                      ...
                      <tr>
                          <td align="left"><?php echo $item_room['area_room']?>m2</td>
                            <td align="left"><?php echo $lib->formatMoney($item_room['cost'])?> VNĐ.</td>
	...
	<section class="ndt-details-slide">
		...
		<ul class="pro-demo">
			...
			<li class="item">
				<figure>
                	<a href="<?php echo $url?>house/<?php echo $item_pro_type['id_house']?>">
					<img src="<?php echo $item_pro_type['image_house']?>" alt="Owl Image">
                    </a>
                    <a href="<?php echo $url?>house/<?php echo $item_pro_type['id_house']?>">
					<div class="sp-cungloai">
                        <p class="item-project-addr" style="color:#FFF;"><?php echo $item_pro_type['addr']?></p>
                        <p class="item-project-addr" style="color:#FF0;">Giá: <?php echo $lib->formatmoney($item_pro_type['cost_house']);?> VNĐ.</p>
                        <p class="project-empty" style="text-decoration:underline; color:#FF0;">
                        <?php if($item_pro_type['office_none']==0)
										{
										?>
                        Phòng trống:
                        					<?php 
													...
													{
														if($data_room_type[$i]['id_house']==$item_pro_type['id_house'])
														{
